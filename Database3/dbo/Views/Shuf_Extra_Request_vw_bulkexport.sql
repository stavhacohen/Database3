...
CREATE view [dbo].[Shuf_Extra_Request_vw_bulkexport] as
select 
...
WHERE (PromotionStartDate='2018-05-29'and CampaignNumberPromo=80014525)
OR (PromotionStartDate='2017-06-06'and CampaignNumberPromo=80012229)
