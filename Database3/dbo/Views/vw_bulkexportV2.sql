...
CREATE view [dbo].[vw_bulkexportV2] as
select 
getdate() as export_date
,ir.PromotionNumber
,PromotionNumberOriginal = Case when len(PromotionNumber) >8 then left(PromotionNumber,len(PromotionNumber)-3) else PromotionNumber END
