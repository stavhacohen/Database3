...
-- =============================================
CREATE PROCEDURE [dbo].[Supplier_update_4_create_fact_performance]
    @run_nr INT, 
	@run_date DATE
AS
BEGIN
...
INSERT INTO PG_update_log
	VALUES(	@run_nr,
			...
			4,
			1,
			'Start of Supplier_update_4_create_fact_performance',
			SYSDATETIME()
		)
...
SELECT 
	...
	,MAX(CAST(LEFT(ISNULL(Promotion_segment,'8'), 1) AS INT)) [id_kpi_promotion_segment]
...
INSERT INTO PG_update_log
	VALUES(	@run_nr,
			...
			4,
			2,
			'End of Supplier_update_4_create_fact_performance',
			SYSDATETIME()
		)
