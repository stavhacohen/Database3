...
-- =============================================
CREATE PROCEDURE [dbo].[MM_update_8_validation_baseline_October_check]
     @run_nr INT = 100
    ,@run_date DATE = '2018-11-20'
    ,@start_date DATE = '2018-06-17'
...
--DELETE FROM dbo.MM_PG_baseline_validation_weekly
--WHERE	  yearweek = @yearweek;

INSERT INTO dbo.MM_PG_baseline_validation_weekly
SELECT	  yearweek,
...
--DELETE FROM dbo.MM_PG_baseline_validation_product
--WHERE	  yearweek = @yearweek;

INSERT INTO dbo.MM_PG_baseline_validation_product
SELECT	  br.yearweek,
		  br.Package_number,
		  br.FDOW,
		  br.LDOW,
