...
-- =============================================
CREATE PROCEDURE [dbo].[MM_update_7c_ROI_promotions_component_2_memory]
	@step INT = 1,
	@run_nr INT = 171,
    @run_date DATE = '2019-01-18',
    @start_date DATE = '2018-12-23',
...
SELECT	  cp.PromotionNumber,
 ...
 ON		  (hd.holiday = 'Pesach' or hd.holiday='Rosh Hashana' or hd.holiday='Sukkot')
	   AND ppi.TransactionDate BETWEEN DATEADD(day,-28,hd.start_date) AND hd.end_date
