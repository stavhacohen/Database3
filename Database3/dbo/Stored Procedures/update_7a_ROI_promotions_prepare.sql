...
-- =============================================
CREATE PROCEDURE [dbo].[update_7a_ROI_promotions_prepare]
    @run_nr INT = 174,
    @run_date DATE = '2019-01-29',
	@step INT = 1,
    @start_date DATE = '2018-09-01',
    @end_date DATE = '2018-09-08',
	@after_days INT = 28
AS
BEGIN
...
SELECT	  pr.*,
		  ...
		  CASE WHEN pr.DiscountType IN (10,14,17,24) THEN '1. Special'
			  ...
			  WHEN pr.DiscountType IN (5,20,21) THEN '4. Monthly' 
			  ELSE '5. Other' END AS 'Discount_type_grouped'
			  ,
