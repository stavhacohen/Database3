...
-- =============================================
Create PROCEDURE [dbo].[MM_update_7k_ROI_promotions_input_ROI_explorer_2016]
    @run_nr INT = 127,
    @run_date DATE = '2018-08-19',
    @step INT = 1,
    @start_date_expl DATE = '2016-08-12',
    @end_date_expl DATE = '2018-08-13'
AS
BEGIN
...
INSERT INTO PG_update_log
	VALUES(	@run_nr,
			...
			7,
			@step,
			'Start of [update_7k_ROI_promotions_input_ROI_explorer_2016]',
			SYSDATETIME()
		)

-- Creates table as input for ROI explorer_2016 tab 'Promotions'
IF OBJECT_ID('tempdb.dbo.#ROI_input_ROI_explorer_2016_promotions','U') IS NOT NULL
    DROP TABLE #ROI_input_ROI_explorer_2016_promotions
...
INTO		  #ROI_input_ROI_explorer_2016_promotions
...
IF OBJECT_ID('dbo.PG_ROI_input_ROI_explorer_2016_promotions','U') IS NOT NULL
    DROP TABLE PG_ROI_input_ROI_explorer_2016_promotions
SELECT	  ro.[PromotionNumber]
      ,[PromotionNumberUnv]
      ,[PromotionDesc]
      ,[PromotionStartDate]
	...
	,pr.CampaignNumberPromo,
		  ...
		  pr.Category_manager,
		  ps.Supplier_ID
INTO		  dbo.PG_ROI_input_ROI_explorer_2016_promotions
FROM		  #ROI_input_ROI_explorer_2016_promotions ro
...
INSERT INTO PG_update_log
	VALUES(	@run_nr,
			...
			7,
			@step,
			'Input for ROI explorer_2016 tab Promotions calculated',
			SYSDATETIME()
		)

-- Creates table as input for ROI explorer_2016 tab 'Promotion_product'
IF OBJECT_ID('dbo.PG_ROI_input_ROI_explorer_2016_promotion_product','U') IS NOT NULL
    DROP TABLE PG_ROI_input_ROI_explorer_2016_promotion_product
SELECT	  PromotionNumber,
		  ProductNumber
INTO		  dbo.PG_ROI_input_ROI_explorer_2016_promotion_product
...
INSERT INTO PG_update_log
	VALUES(	@run_nr,
			...
			7,
			@step,
			'Input for ROI explorer_2016 tab Promotion_product calculated',
			SYSDATETIME()
		)

-- Creates table as input for ROI explorer_2016 tab 'Products'
IF OBJECT_ID('dbo.PG_ROI_input_ROI_explorer_2016_products','U') IS NOT NULL
    DROP TABLE PG_ROI_input_ROI_explorer_2016_products
SELECT	  ProductNumber,
		  Product_name_HE,
		  Category_name_HE,
		  Group_name_HE,
		  Subgroup_name_HE
INTO		  dbo.PG_ROI_input_ROI_explorer_2016_products
FROM		  PG_ROI_result_product_daily
WHERE	  PromotionStartDate BETWEEN @start_date_expl AND @end_date_expl
...
INSERT INTO PG_update_log
	VALUES(	@run_nr,
			...
			7,
			@step,
			'Input for ROI explorer_2016 tab Products calculated',
			SYSDATETIME()
		)

-- Creates table as input for ROI explorer_2016 tab 'Suppliers'
IF OBJECT_ID('dbo.PG_ROI_input_ROI_explorer_2016_suppliers','U') IS NOT NULL
    DROP TABLE PG_ROI_input_ROI_explorer_2016_suppliers
SELECT	  Supplier_ID,
		  Supplier_name_HE
INTO		  dbo.PG_ROI_input_ROI_explorer_2016_suppliers
...
INSERT INTO PG_update_log
	VALUES(	@run_nr,
			...
			7,
			@step,
			'Input for ROI explorer_2016 tab Suppliers calculated',
			SYSDATETIME()
		)

--DROP TABLE  [Shufersal].[dbo].[PG_ROI_input_ROI_explorer_2016_groceries_promotions]
SELECT	  *
INTO		  [Shufersal].[dbo].[PG_ROI_input_ROI_explorer_2016_groceries_promotions]
FROM		  [Shufersal].[dbo].[PG_ROI_input_ROI_explorer_2016_promotions]
WHERE	  Department_name_EN = 'Groceries'

--DROP TABLE  [Shufersal].[dbo].[PG_ROI_input_ROI_explorer_2016_groceries_promotion_product]
SELECT	  *
INTO		  [Shufersal].[dbo].[PG_ROI_input_ROI_explorer_2016_groceries_promotion_product]
FROM		  [Shufersal].[dbo].[PG_ROI_input_ROI_explorer_2016_promotion_product]
WHERE	  PromotionNumber IN (SELECT PromotionNumber FROM [Shufersal].[dbo].[PG_ROI_input_ROI_explorer_2016_groceries_promotions])

--DROP TABLE  [Shufersal].[dbo].[PG_ROI_input_ROI_explorer_2016_groceries_products]
SELECT	  *
INTO		  [Shufersal].[dbo].[PG_ROI_input_ROI_explorer_2016_groceries_products]
FROM		  [Shufersal].[dbo].[PG_ROI_input_ROI_explorer_2016_products]
WHERE	  ProductNumber IN (SELECT ProductNumber FROM [Shufersal].[dbo].[PG_ROI_input_ROI_explorer_2016_groceries_promotion_product])

--DROP TABLE  [Shufersal].[dbo].[PG_ROI_input_ROI_explorer_2016_groceries_suppliers]
SELECT	  *
INTO		  [Shufersal].[dbo].[PG_ROI_input_ROI_explorer_2016_groceries_suppliers]
FROM		  [Shufersal].[dbo].[PG_ROI_input_ROI_explorer_2016_suppliers]
...
INSERT INTO PG_update_log
	VALUES(	@run_nr,
			...
			7,
			@step,
			'Input for ROI explorer_2016 for Groceries calculated',
			SYSDATETIME()
		)
...
INSERT INTO PG_update_log
	VALUES(	@run_nr,
			...
			7,
			@step,
			'End of [update_7k_ROI_promotions_input_ROI_explorer_2016]',
			SYSDATETIME()
		)
