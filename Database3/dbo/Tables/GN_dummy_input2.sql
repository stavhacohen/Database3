CREATE TABLE [dbo].[GN_dummy_input2] (
    ...
    [Supplier_name_HE]                   NVARCHAR (1)    NULL,
    [Catalog_Price]                      DECIMAL (10, 2) NULL,
    [SellOut_Prod]                       DECIMAL (10, 2) NULL,
    [SellOut_Prom]                       DECIMAL (10, 2) NULL,
    [SellIn]                             DECIMAL (10, 2) NULL,
    [Revenue_1_promotion_Cat]            DECIMAL (18)    NULL,
    [Revenue_2_subs_promo_Cat]           DECIMAL (18)    NULL,
    [Revenue_3_subs_group_Cat]           DECIMAL (18)    NULL,
    [Revenue_4_promobuyer_existing_Cat]  DECIMAL (18)    NULL,
    [Revenue_5_promobuyer_new_Cat]       DECIMAL (18)    NULL,
    [Revenue_6_new_customer_Cat]         DECIMAL (18)    NULL,
    [Revenue_7_Product_adoption_Cat]     DECIMAL (18)    NULL,
    [Revenue_8_hording_Cat]              DECIMAL (18)    NULL,
    [Revenue_Value_Effect_Cat]           DECIMAL (18)    NULL,
    [Supplier_segment]                   NVARCHAR (1)    NULL
);
