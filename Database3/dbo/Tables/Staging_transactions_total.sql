CREATE TABLE [dbo].[Staging_transactions_total] (
...
CREATE CLUSTERED INDEX [cl_index_householdID]
    ON [dbo].[Staging_transactions_total]([HouseholdID] ASC);


GO
CREATE NONCLUSTERED INDEX [index_productnr]
    ON [dbo].[Staging_transactions_total]([ProductNumber] ASC);


GO
CREATE NONCLUSTERED INDEX [index_transDate]
    ON [dbo].[Staging_transactions_total]([TransactionDate] ASC);
